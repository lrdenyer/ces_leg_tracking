...
Visit the `data` folder to find the constructed dataset of legislative bills.

Visit the `code` folder to find R code to clean and analyze the legislative bill data.
